...
def fetch_stock_price(ticket):
    stock = yf.download(ticket, start="2023-08-24", end="2024-08-24")
    return stock

yahoo_finance_tool = Tool(
    name = "Yahoo Finance Tool",
    description = "Fetches stocks prices for {ticket} from the laster year about a specific company from Yahoo Finance API",
...
stockPriceAnalyst = Agent(
    ...
    backstory="""You are highly experienced in analyzing the price of an specific stock and make predictions about its future price""",
    verbose=True,
    llm= llm,
    max_iter = 5,
    memory = True,
...
""",
    backstory="""You are highly experienced in analyzing the market trends, news and have tracked assets for more than 10 years.
    
    You are also master level analysis in the tradicional markets and have deep understanding of human psychology.
...
get_news = Task(
    ...
    The currente date is {datetime.now()}.
...
stockAnalystWrite = Agent(
    ...
    backstory = """You are widely accepted as the best stock analyst in the market. You understand complex concepts and create compelling stories and narratives that resonate with wider audiences.
...
writeAnalyses = Task(
    ...
    expected_output = """"An eloquent 3 paragraphs newsletter formatted as markdown in an easy readble manner. It should contain:
